...
all: main.o ins_conversion.o ins_out.o binary_translation.o asm_parser.o code_block.o
	g++ -g3 -o BinaryTanslate main.o ins_conversion.o ins_out.o binary_translation.o asm_parser.o code_block.o


code_block.o: code_block.cpp code_block.h
	$(GCC) $(GCC_OPTIONS) code_block.cpp
